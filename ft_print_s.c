...
char *ft_print_s_1(t_spec spec, char *s, int ln)
{
    if (spec.minus == 1 && spec.precision >= 0 && spec.width >= 0 && !(*s))
        s = ft_left(s, spec.width, 0, ' ');
    else if (spec.minus == 1 && spec.precision >= 0 && spec.width >= 0 && (spec.precision < spec.width))
    ...
    else if (spec.zero == 1 && spec.precision >= 0 && (spec.precision < spec.width))
...
char *ft_print_s_2(t_spec spec, char *s, int ln)
{
    if (spec.precision >= 0 && spec.width >= 0 && (spec.precision > spec.width) && spec.precision <= ln)
        s = ft_right(s, spec.precision, ln, ' ');
    else if (spec.precision >= 0 && spec.width >= 0 && (spec.precision > spec.width) && spec.precision > ln && spec.width > ln)
