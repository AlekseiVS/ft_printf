...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/17 13:25:50 by osokoliu          #+#    #+#             */
/*   Updated: 2018/03/17 13:27:49 by osokoliu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_print_d_i(va_list ap, t_spec spec)
{
	...
	s = ft_itoa(n);
	ln = ft_strlen(s);
	if (spec.width > 0 || spec.precision >= 0 || spec.plus == 1 ||
		spec.minus == 1 || spec.zero == 1 || spec.space == 1)
	{
